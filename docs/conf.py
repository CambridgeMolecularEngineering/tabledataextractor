...
htmlhelp_basename = 'TableDataExtractordoc'
...
man_pages = [
    (master_doc, 'tabledataextractor', 'TableDataExtractor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TableDataExtractor', 'TableDataExtractor Documentation',
     author, 'TableDataExtractor', 'One line description of project.',
     'Miscellaneous'),
]
