...
from tabledataextractor.table.algorithms import find_cc4, find_cc1_cc2, prefix_duplicate_labels
...
class Table:
    ...
    def _duplicate_spanning_cells(self, table):
        ...
        try:
            cc1, cc2 = find_cc1_cc2(self, find_cc4(self), self.pre_cleaned_table)
        ...
        diff_col_length = 0
        if self._configs['use_prefixing']:
            temp2 = prefix_duplicate_labels(self, temp)
        ...
        try:
            cc1, cc2 = find_cc1_cc2(self, find_cc4(self), temp2)
        except (MIPSError, TypeError):
            log.error("Spanning cells update was not performed due to failure of MIPS algorithm.")
            return table
        finally:
    ...
    #     try:
    #         cc1, cc2 = find_cc1_cc2(self, find_cc4(self), table)
    #     except (MIPSError, TypeError):
    ...
    #         try:
    #             cc1_new, cc2_new = find_cc1_cc2(self, find_cc4(self), prefixed_table)
    #         except (MIPSError, TypeError):
